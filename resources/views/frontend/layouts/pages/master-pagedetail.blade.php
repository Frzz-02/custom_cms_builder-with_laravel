...
<head>
    ...
    <title>{{ $page->meta_title ?? $page->title }} | {{ $settings->site_title ?? 'ApexWorks' }}</title>
    <meta name="description" content="{{ $page->meta_description ?? $settings->site_description }}">
    <meta name="keywords" content="{{ $page->meta_keywords ?? $settings->site_keywords }}">
