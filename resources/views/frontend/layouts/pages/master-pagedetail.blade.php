{{--
    master-pagedetail.blade.php
    Layout for individual CMS page / content detail views.
    Provides: reading progress bar, breadcrumb slot, scroll-reveal, flash toasts.

    Child view usage:
        @extends('frontend.layouts.pages.master-pagedetail')
        @section('title', $page->meta_title)
        @section('description', $page->meta_description)
        @section('breadcrumb_label', $page->title)   ← overrides default breadcrumb text
        @section('page_title', $page->title)          ← shown below breadcrumb nav
...
<head>
    ...
    <style>
        ...
        /* Prose — applied inside .page-content wrapper */
        .page-content h2  { font-size:1.5rem;  font-weight:600; margin:2rem 0 .75rem; }
        .page-content h3  { font-size:1.25rem; font-weight:600; margin:1.5rem 0 .5rem; }
        .page-content p   { margin-bottom:1.25rem; line-height:1.8; color:#374151; }
        .page-content ul,
        .page-content ol  { padding-left:1.5rem; margin-bottom:1.25rem; }
        .page-content li  { margin-bottom:.4rem; line-height:1.75; }
        .page-content a   { color:#4f46e5; text-decoration:underline; }
        .page-content img { max-width:100%; border-radius:.5rem; margin:1.5rem 0; }
        ...
        .page-content th,
        .page-content td   { border:1px solid #e5e7eb; padding:.6rem 1rem; font-size:.95rem; }
...
<body class="bg-white text-gray-900 antialiased">
    ...
    @else
        <section class="bg-gray-50 border-b border-gray-200 pt-20">
            <div class="w-full max-w-[1920px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-24 py-5">
                <nav class="flex items-center gap-2 text-sm text-gray-500">
                    ...
                    <span class="text-gray-900 font-medium truncate">@yield('breadcrumb_label', 'Halaman')</span>
                </nav>
                @hasSection('page_title')
                    <h1 class="text-2xl sm:text-3xl font-semibold text-gray-900 mt-3 leading-tight">
                        @yield('page_title')
                    </h1>
                @endif
            </div>
    ...
    <!-- Pure JS: page reveal + reading bar + scroll-reveal + scroll-to-top -->
    <script>
