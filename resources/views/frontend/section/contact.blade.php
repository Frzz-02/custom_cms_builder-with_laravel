...
@php
    ...
    $contactItems = !empty($contactIds)
        ...
        : collect();
    $primaryContact = $contactItems->first();
    $waNumber = $primaryContact && $primaryContact->contact_1
        ...
        <div class="w-full max-w-[1920px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-24 relative z-10">
            <div class="text-center">
                ...
                <h2 class="text-4xl md:text-5xl text-gray-900 mb-6 leading-tight" data-reveal data-reveal-delay="2">
                    {!! $shortcode->contact_title_1 ?? 'Siap Berbelanja<br>Untuk Bisnis Anda?' !!}
                </h2>
                <p class="text-lg text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed" data-reveal data-reveal-delay="3">
                    {{ $shortcode->contact_subtitle ?? 'Konsultasikan kebutuhan bisnis Anda secara gratis. Kami siap membantu dari pemilihan produk hingga pengiriman!' }}
                </p>
