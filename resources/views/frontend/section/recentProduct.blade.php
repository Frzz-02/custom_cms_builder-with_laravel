        ...
        <div class="w-full max-w-[1920px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-24">
            ...
            <div class="relative" x-data="{
                ...
                <div x-ref="slider" class="flex gap-4 overflow-x-auto scrollbar-hide scroll-smooth pb-4" style="scrollbar-width: none; -ms-overflow-style: none;">
                    ...
                    @php
                        $prodImg = $product->image ? asset('storage/' . $product->image) : asset('images/placeholder.jpg');
                    ...
                    <div class="group flex-shrink-0 w-[280px] card-lift" data-reveal data-reveal-delay="{{ $prodIdx + 1 }}">
                        ...
                        <div class="pt-4">
                            ...
                            <a href="{{ route('produk.show', $product->slug) }}" class="inline-block px-4 py-2 border border-gray-400 text-gray-700 text-xs hover:bg-gray-900 hover:text-white hover:border-gray-900 transition-colors">
                                Lihat Produk
                            </a>
                        </div>
                    </div>
