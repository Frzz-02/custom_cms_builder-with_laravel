            ...
            <div class="mb-6">
                ...
                <div class="flex gap-4 mb-4">
                    <label class="flex items-center cursor-pointer">
                        <input type="radio" name="image_type" value="upload" class="mr-2" onchange="toggleImageInput('upload')" checked>
                        <span class="text-sm text-gray-700">Upload Image</span>
                    </label>
                    <label class="flex items-center cursor-pointer">
                        <input type="radio" name="image_type" value="url" class="mr-2" onchange="toggleImageInput('url')">
                ...
                <div id="urlSection" class="mb-4 hidden">
                    <input type="url" name="image_url" id="image_url" placeholder="https://example.com/image.jpg" oninput="previewImageUrl(this)"
