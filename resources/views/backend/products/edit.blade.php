...
<div class="p-6">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-1">Update product information to your inventory</p>
        </div>

        <!-- Form -->
        <form action="{{ route('backend.products.update', $product) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="products_code" id="products_code" value="{{ old('products_code', $product->products_code) }}" required
                ...
                <div class="mt-6">
                    ...
                    <textarea name="overview" id="overview" rows="3"
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('overview') border-red-500 @enderror">{{ old('overview', $product->overview) }}</textarea>
                    @error('overview')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="content" id="content" rows="6"
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('content') border-red-500 @enderror">{{ old('content', $product->content) }}</textarea>
                    @error('content')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="image_title" id="image_title" value="{{ old('image_title', $product->image_title) }}"
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="meta_description" id="meta_description" rows="3"
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('meta_description', $product->meta_description) }}</textarea>
                </div>
