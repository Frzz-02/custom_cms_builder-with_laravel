    ...
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6 mb-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-slate-800">Create Team Member</h1>
                    <p class="text-slate-600 mt-1">Add data for section teams</p>
                </div>
            </div>
        </div>

        <form action="{{ route('backend.teams.store') }}" method="POST">
            @csrf
